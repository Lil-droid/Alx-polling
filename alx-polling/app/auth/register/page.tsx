          ...
          <div className="-space-y-px rounded-md shadow-sm">
            ...
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="relative block w-full border-0 py-1.5 px-3 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-blue-600"
